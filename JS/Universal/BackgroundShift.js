var fondos = [
	...
	'url(https://www.include-poetry.com/IP-Sources/Multimedia/Fondos/24.jpg)',
	'url(https://www.include-poetry.com/IP-Sources/Multimedia/Fondos/25.jpg)',
	'url(https://www.include-poetry.com/IP-Sources/Multimedia/Fondos/26.jpg)',
	'url(https://www.include-poetry.com/IP-Sources/Multimedia/Fondos/27.jpg)'
];
...
if (x+1 == 4 || x+1 == 7 ||  x+1 == 14){
	posbg = 'left';
} else if ( x+1 == 8 ||  x+1 == 9 ||  x+1 == 15 ||  x+1 == 17 || x+1 == 21) {
	posbg = 'right';
} else posbg = 'center';
